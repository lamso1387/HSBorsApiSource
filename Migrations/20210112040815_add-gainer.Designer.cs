...
namespace HSBors.Migrations
{
    ...
    [Migration("20210112040815_add-gainer")]
    partial class addgainer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HSBors.Models.Gainer", b =>
                {
                    ...
                    b.Property<long>("primary_gainer_id");

                    b.Property<long>("secondary_gainer_id");
                    ...
                    b.HasIndex("secondary_gainer_id");

                    b.HasIndex("primary_gainer_id", "secondary_gainer_id")
                        .IsUnique();
            ...
            modelBuilder.Entity("HSBors.Models.Gainer", b =>
                {
                    b.HasOne("HSBors.Models.User", "primary_gainer")
                        .WithMany("primary_gainers")
                        .HasForeignKey("primary_gainer_id")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("HSBors.Models.User", "secondary_gainer")
                        .WithMany("secondary_gainers")
                        .HasForeignKey("secondary_gainer_id")
                        .OnDelete(DeleteBehavior.Restrict);
                });
